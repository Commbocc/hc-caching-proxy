...
exports.config = {
  tenantId: process.env.POWERBI_TENET_ID,
  clientId: process.env.POWERBI_CLIENT_ID,
  clientSecret: process.env.POWERBI_CLIENT_SECRET,
  workspaceId: process.env.POWERBI_WORKSPACE_ID,
  scope: process.env.POWERBI_API_SCOPE,
...
exports.validateConfig = (conf) => {
  ...
  if (
    conf.authenticationMode.toLowerCase() !== 'masteruser' &&
    conf.authenticationMode.toLowerCase() !== 'serviceprincipal'
  ) {
